...
public class HomeActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_home);//这是设置活动布局的,按住ctrl+单击,可以调转到定义处
        //setContentView(R.layout.activity_main);
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);//这是顶部工具条
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_camera) {//这是选照相机对应项的动作,这里面可以有任意你想要做的跳转或动作,比如跳转到你之前的MainActivity
